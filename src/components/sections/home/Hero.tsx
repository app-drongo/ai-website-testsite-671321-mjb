...
const DEFAULT_HERO = {
  badge: 'New: TestSite Platform',
  title: 'Build & test websites with',
  titleHighlight: 'Professional animations',
  description:
    'Create stunning test websites with smooth scroll-triggered animations. Perfect for prototyping, testing, and showcasing your ideas.',
  features: ['Smooth animations', 'Responsive design', 'Easy to customize', 'Modern UI components'],
  ...
  statsLabel2: 'Animations',
  statsValue2: 'Smooth 60fps',
} as const;
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex flex-col justify-center">
            ...
            <motion.div variants={titleVariants} className="mt-8 flex flex-col gap-4 sm:flex-row">
          ...
          <motion.div variants={floatingVariants} animate="animate" className="relative">
            ...
            <motion.div
              variants={badgeVariants}
              className="absolute -right-6 -top-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block"
            >
            ...
            <motion.div
              variants={badgeVariants}
              className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block"
            >
